# SAML
[![](https://godoc.org/github.com/tbugai/saml?status.svg)](http://godoc.org/github.com/tbugai/saml)

[![Build Status](https://travis-ci.org/tbugai/saml.svg?branch=master)](https://travis-ci.org/tbugai/saml)
...
Please do not report security issues in the issue tracker. Rather, please contact me directly at ross@kndr.org ([PGP Key `78B6038B3B9DFB88`](https://keybase.io/tbugai)).
